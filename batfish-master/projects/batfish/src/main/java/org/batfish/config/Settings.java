...
public final class Settings extends BaseSettings implements GrammarSettings {
  ...
  private static final String COMPUTE_CONTROL_PLANE = "compute-control-plane";

  private static final String ARG_DEBUG_FLAGS = "debugflags";

  private static final String ARG_PARSE_REUSE = "parsereuse";

  private static final String VERIFY_ALL_REACHABILITY = "verify-all-reachability";
  ...
  public static final String COMPUTE_VIOLATION_TREE = "compute-violation-tree";

  public static final String VERIFY_SINGLE_REACHABILITY = "verify-single-reachability";

  public static final String SRC_ROUTER = "src-router";

  public static final String SRC_VRF = "src-vrf";

  public static final String DST_ROUTER = "dst-router";

  public static final String DST_VRF = "dst-vrf";

  public static final String DST_PREFIX = "dst-prefix";

  public static final String GET_VIOLATION_TREE = "get-violation-tree";
  ...
  public boolean getVerifySingleReachability()
  {
    return _config.getBoolean(BfConsts.VERIFY_SINGLE_REACHABILITY);
  }
  public boolean getGetViolationTree()
  {
    return _config.getBoolean(BfConsts.GET_VIOLATION_TREE);
  }
  public String getSrcRouter()
  {
    return _config.getString(BfConsts.SRC_ROUTER);
  }
  public String getSrcVRF()
  {
    return _config.getString(BfConsts.SRC_VRF);
  }
  public String getDstRouter()
  {
    return _config.getString(BfConsts.DST_ROUTER);
  }
  ...
  {
    return _config.getString(BfConsts.DST_VRF);
  }
  ...
  {
    return _config.getString(BfConsts.DST_PREFIX);
  }
  ...
  public boolean getComputeControlPlane()
  {
    return _config.getBoolean(BfConsts.COMPUTE_CONTROL_PLANE);
  }
  ...
  public boolean getVerifyAllReachability()
  {
    return _config.getBoolean(BfConsts.VERIFY_ALL_REACHABILITY);
  }
  public boolean getComputeViolationTree()
  {
    return _config.getBoolean(BfConsts.COMPUTE_VIOLATION_TREE);
  }
  ...
  private void initConfigDefaults() {
    ...
    setDefaultProperty(COMPUTE_CONTROL_PLANE, false);
    setDefaultProperty(VERIFY_ALL_REACHABILITY, false);
    setDefaultProperty(COMPUTE_VIOLATION_TREE, false);
    setDefaultProperty(VERIFY_SINGLE_REACHABILITY, false);
    setDefaultProperty(GET_VIOLATION_TREE, false);
    setDefaultProperty(SRC_ROUTER, "src-router");
    setDefaultProperty(SRC_VRF, "src-vrf");
    setDefaultProperty(DST_ROUTER, "dst-router");
    setDefaultProperty(DST_VRF, "dst-vrf");
    setDefaultProperty(DST_PREFIX, "dst-prefix");
  }
  ...
  private void initOptions() {
    ...
    addBooleanOption(COMPUTE_VIOLATION_TREE, "compute the final verification result and violation tree");
    addBooleanOption(COMPUTE_CONTROL_PLANE, "compute the solution of control plane");
    addBooleanOption(VERIFY_ALL_REACHABILITY, "verify all reachability in every virtual network");
    addOption(SRC_ROUTER, "src router", ARGNAME_NAME);
    addOption(SRC_VRF, "src vrf", ARGNAME_NAME);
    addOption(DST_ROUTER, "dst router", ARGNAME_NAME);
    addOption(DST_VRF, "dst vrf", ARGNAME_NAME);
    addOption(DST_PREFIX, "dst prefix", ARGNAME_NAME);
    addBooleanOption(VERIFY_SINGLE_REACHABILITY, "verify specific reachability");
    addBooleanOption(GET_VIOLATION_TREE, "get violation tree");
  ...
  public void parseCommandLine(String[] args) {
    ...
    getBooleanOptionValue(COMPUTE_CONTROL_PLANE);
    getBooleanOptionValue(VERIFY_ALL_REACHABILITY);
    getBooleanOptionValue(COMPUTE_VIOLATION_TREE);
    getBooleanOptionValue(VERIFY_SINGLE_REACHABILITY);
    getBooleanOptionValue(GET_VIOLATION_TREE);
    getStringOptionValue(SRC_ROUTER);
    getStringOptionValue(SRC_VRF);
    getStringOptionValue(DST_ROUTER);
    getStringOptionValue(DST_VRF);
    getStringOptionValue(DST_PREFIX);
  }
