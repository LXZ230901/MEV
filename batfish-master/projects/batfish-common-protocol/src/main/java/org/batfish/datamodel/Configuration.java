...
public final class Configuration implements Serializable {
  ...
  private Map<Integer, Nve> _nves;

  public List<Vlan> _vlans;
  ...
  public void setNves(Map<Integer, Nve> nves)
  {
    this._nves.putAll(nves);
  }

  public void addVlans(int id, Integer vni)
  {
    Vlan vlan = new Vlan(id);
    vlan.setVni(vni);
    this._vlans.add(vlan);
  }

  public Map<Integer, Nve> getNves()
  {
    return this._nves;
  }
