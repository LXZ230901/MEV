...
public class BgpProcess implements Serializable {
  ...
  public static class Builder {
    ...
    public @Nonnull Builder setLocalAs(
  ...
  public HashMap<AddressFamily.Type, List<Prefix>> _networkPrefixs;
  ...
  private BgpProcess(
      ...
      @Nonnull Long localAs,
      HashMap<AddressFamily.Type, List<Prefix>> networkPrefixs) {
    ...
    _localAs = localAs;
    _networkPrefixs = new HashMap<>(networkPrefixs);
  }
  ...
  public HashMap<AddressFamily.Type, List<Prefix>> getNetworkPrefixs()
  {
    return _networkPrefixs;
  }

  public void addNetworkPrefix(String addressFamily, Prefix prefix)
  {
    if (addressFamily.equals("IPv4"))
    {
      if (!_networkPrefixs.containsKey(AddressFamily.Type.IPV4_UNICAST))
      {
        _networkPrefixs.put(AddressFamily.Type.IPV4_UNICAST, new ArrayList<>());
      }
      _networkPrefixs.get(AddressFamily.Type.IPV4_UNICAST).add(prefix);
