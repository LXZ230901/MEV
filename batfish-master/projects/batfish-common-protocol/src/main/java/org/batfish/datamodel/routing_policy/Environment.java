...
import org.batfish.MEV.Message;
...
public class Environment {
  ...
  private String _routeSourceVrf;
  ...
  private Message.Builder _outputMessage;
  ...
  public void setOriginlMessage(Message message)
  {
  ...
  public void setOutputMessage(Message.Builder message)
  {
    this._outputMessage = message;
  }

  public Message.Builder getOutputMessage()
  {
  ...
  public static final class Builder {
    ...
    public Builder setOriginalMessage(Message message)
    {
      _originalMessage = message;
      return this;
    }

    public Builder setOutputMessage(Message.Builder message)
    {
