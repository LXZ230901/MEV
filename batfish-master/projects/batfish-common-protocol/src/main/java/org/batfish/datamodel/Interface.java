...
public final class Interface extends ComparableStructure<String> {
  ...
  public HashMap<Prefix,Interface> _neighborInterfaces;
  ...
  private Interface(String name, Configuration owner, @Nonnull InterfaceType interfaceType) {
    ...
    _vrrpGroups = ImmutableSortedMap.of();
    _neighborInterfaces = new HashMap<>();
  }
  ...
  public void addNeighborInterface(Prefix prefix, Interface neighborInterface)
  {
    _neighborInterfaces.put(prefix, neighborInterface);
  }

  public HashMap<Prefix, Interface> getNeighborInterfaces()
  {
    return _neighborInterfaces;
  }
}
