...
public final class Topology implements Serializable {
  ...
  public Map<String, Edge> computeInterfaceEdges() {
    Map<String, Edge> builders = new HashMap<>();
    for (Edge edge : this._edges) {
      String node1 = edge.getNode1();
      String inter1 = edge.getInt1();
      String node2 = edge.getNode2();
      String inter2 = edge.getInt2();
      builders.put(node1 + "-" + inter1, edge);
    }
    return builders;
  }
