...
public class EvpnAttribute extends Attribute {
    ...
    public EvpnAttribute(int AD, Set<StandardCommunity> community, AsPath asPath, Long localPreference, Integer MED, Set<ExtendedCommunity> RTs, Integer vni, RouteDistinguisher rd)
    {
        super(AD, 0);
    ...
    public EvpnAttribute(int AD, Set<StandardCommunity> community, AsPath asPath, Long localPreference, Integer MED, Set<ExtendedCommunity> RTs, Integer vni, boolean reflector, List<Long> routerIdList, RouteDistinguisher rd)
    {
        super(AD, 0);
        this._community = new HashSet<>(community);
        this._asPath = AsPath.of(asPath.getAsSets());
...
//        }
    ...
    public BgpAttribute toBgpAttribute()
    {
        BgpAttribute.Builder bgpAttribute = new BgpAttribute.Builder(this._AD);
        bgpAttribute.setCommunity(this._community);
        bgpAttribute.setExtCommunity(this._RTs);
        bgpAttribute.setAsPath(this._asPath);
        bgpAttribute.setLocalPreference(this._localPreference);
        bgpAttribute.setMED(this._MED);
        bgpAttribute.setRouterIdList(this._routerIdList);
        return bgpAttribute.build();
    }
    ...
    public static class Builder extends Attribute.Builder<Builder>{
        ...
        public Builder setRD(RouteDistinguisher rd)
        {
            this._rd = rd;
            return this;
        }
        ...
        public EvpnAttribute build() {
            return new EvpnAttribute(_AD, _community, _asPath, _localPreference, _MED, _RTs, _vni, _reflector, _routerIdList, _rd);
        }
    }
