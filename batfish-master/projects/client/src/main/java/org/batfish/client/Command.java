...
public enum Command {
  ...
  TEST("test"),
  COMPUTE_CONTROL_PLANE("compute-control-plane"),
  VERIFY_ALL_REACHABILITY("verify-all-reachability"),
  VALIDATE_TEMPLATE("validate-template"),

  COMPUTE_VIOLATION_TREE("compute-violation-tree"),
  VERIFY_SINGLE_REACHABILITY("verify-single-reachability"),
  GET_VIOLATION_TREE("get-violation-tree");
